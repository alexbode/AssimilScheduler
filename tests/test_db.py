...
class TestDb(unittest.TestCase):
    ...
    def test_insert_review_and_get_all_reviews(self):
        ...
        self.assertEqual(reviews[0], (date.strftime("%Y-%m-%d"), lesson, review))
    ...
    def test_undo_last_review(self):
        ...
        self.assertIn((date.strftime("%Y-%m-%d"), 3, ReviewType.READ), reviews_before_undo)
        self.assertIn((date.strftime("%Y-%m-%d"), 2, ReviewType.READ), reviews_before_undo)
        self.assertIn((date.strftime("%Y-%m-%d"), 1, ReviewType.READ), reviews_before_undo)
        ...
        self.assertNotIn((date.strftime("%Y-%m-%d"), 3, ReviewType.READ), reviews_after_undo)
        self.assertIn((date.strftime("%Y-%m-%d"), 2, ReviewType.READ), reviews_after_undo)
        self.assertIn((date.strftime("%Y-%m-%d"), 1, ReviewType.READ), reviews_after_undo)